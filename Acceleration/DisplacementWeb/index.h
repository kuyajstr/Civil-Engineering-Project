...
<body>
    ...
    <div class="header">
        <!-- <img src="http://www.ndmu.edu.ph/wp-content/uploads/2015/12/cet-300x225.png" height="250px"> -->
        <h1>THE USE OF INTERNET OF THINGS (IOT) BASED ACCELEROMETER SENSOR <BR> AS STRUCTURAL HEALTH MONITORING DEVICE
        </h1>
        <!-- <img src="https://portal.ndmu.edu.ph/img/NDMU-Logo.png" height="250px"> -->
    </div>
    ...
    <div class="content">
        ...
        <div id="textData" style="width:49%; float:left">
        ...
        <div id="diagramData" style="width:49%; float:right; margin-right: 10px;">
            <!-- <h2>Plots</h2> -->
    ...
    <script>
            ...
            xhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    updateReadings("cZ", "hZ", zValue);
                     ...
                     updateChart(xChart, xValue);
                     updateChart(yChart, yValue);
                     updateChart(zChart, zValue);
                }
            };
        ...
        const xChart = createChart('xChart');
        const yChart = createChart('yChart');
        const zChart = createChart('zChart');
